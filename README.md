...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-20 07:58`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8a5e9df3-9fee-420d-abec-1d033321c84c.git
$ cd 8a5e9df3-9fee-420d-abec-1d033321c84c
```
